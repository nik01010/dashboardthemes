...
| Grey light | Simple, light theme using a grey colour schemes |
| Grey dark | Demonstrates use of inverted dark colour schemes |
| OneNote | Styled similarly to the OneNote application |
| Poor man's Flatly | Poor man's version of the <a href="https://bootswatch.com/flatly/" target="_blank">Flatly</a> theme
| Purple gradient | Demonstrates high use of gradients and a smaller sidebar |
